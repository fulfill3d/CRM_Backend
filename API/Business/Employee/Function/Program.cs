...
using CRM.API.Business.Employee;
...
var host = new HostBuilder()
    ...
    .ConfigureServices((context, services) =>
    {
        ...
        services.RegisterServices(new DatabaseOption
            ...
            (tokenOptions) =>
            {
                tokenOptions.Read = configuration["CRM_AuthScope_Business_Employee_Read"] ?? string.Empty;
                tokenOptions.Write = configuration["CRM_AuthScope_Business_Employee_Write"] ?? string.Empty;
            });
    })
    .Build();
