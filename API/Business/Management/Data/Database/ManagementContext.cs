...
namespace CRM.API.Business.Management.Data.Database
{
    public partial class ManagementContext(DbContextOptions<ManagementContext> options) : DbContext(options)
    {
