...
using CRM.API.Business.Appointment;
...
var host = new HostBuilder()
    ...
    .ConfigureServices((context, services) =>
    {
        ...
        services.RegisterServices(new DatabaseOption
            ...
            (tokenOptions) =>
            {
                tokenOptions.Read = configuration["CRM_AuthScope_Business_Appointment_Read"] ?? string.Empty;
                tokenOptions.Write = configuration["CRM_AuthScope_Business_Appointment_Write"] ?? string.Empty;
            });
    })
    .Build();
